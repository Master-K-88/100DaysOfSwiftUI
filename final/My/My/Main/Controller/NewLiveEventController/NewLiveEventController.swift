//
//  NewLiveEventController.swift
//  jamit
//
//  Created by Prof K on 5/3/22.
//  Copyright © 2022 Jamit Technologies, Inc. All rights reserved.
//

import UIKit

class NewLiveEventController: JamitRootViewController {
    ...
    private let subTitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Minute News"
        label.translatesAutoresizingMaskIntoConstraints = false
        label.font = UIFont(name: "Poppins-Medium", size: 18)
        return label
    }()
    
    private let webLinkView: UIView = {
        let view = UIView()
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
    
    private let webLinkLabel: UILabel = {
        let label = UILabel()
        label.text = "Title of weblink"
        label.translatesAutoresizingMaskIntoConstraints = false
        label.font = UIFont(name: "Poppins-Medium", size: 18)
        return label
    }()
    
    private let weblinkImage: UIImageView = {
...
//        btnStackView.addArrangedSubview(btnMine)
        ...
        scrollView.pin(to: view, top: 0, left: 20, bottom: 0, right: -20)
...
extension NewLiveEventController: UICollectionViewDataSource {
...
extension NewLiveEventController: UICollectionViewDelegate {
...
extension NewLiveEventController: UICollectionViewDelegateFlowLayout {
